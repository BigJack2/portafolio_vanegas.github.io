...
const TRANSLATIONS = {
  es: {
    ...
    service_back_desc: "Desarrollador Backend con sólida experiencia en C#, .NET, PHP y SQL, enfocado en la construcción de sistemas robustos, escalables y mantenibles. Aplico buenas prácticas como Clean Code, SOLID y KISS, realizo pruebas unitarias para asegurar calidad del software y gestiono integraciones mediante APIs REST.",
    service_back_desc2: "Cuento con experiencia en control de versiones, resolución de incidencias y documentación técnica, aportando soluciones eficientes y orientadas a las necesidades del negocio.",
    service_data: "Analista de Datos y uso de SQL",
    service_data_desc: "Analista de Datos con capacidad de análisis y dominio de SQL, orientado a la extracción, transformación y análisis de información para la toma de decisiones.",
    service_data_desc2: "Cuento con experiencia en SQL Server y PostgreSQL, así como bases en MongoDB, lo que me permite trabajar con datos estructurados y no estructurados, apoyando procesos de soporte, optimización y desarrollo de soluciones basadas en datos.",
    service_marketing: "Marketing digital",
    service_marketing_desc: "Como desarrollador con habilidades autodidactas en diseño y marketing digital, cuento con la capacidad de identificar oportunidades de mejora en la presencia digital y aplicar ajustes estratégicos que alinean la solución técnica con los objetivos del negocio.",
    service_analista: "Analista de desarrollo",
    service_analista_desc: "Gracias a mi sólida experiencia técnica y capacidad de análisis, puedo identificar y definir requerimientos para el desarrollo de aplicaciones, evaluando de forma precisa el alcance, los tiempos, los costos y el nivel de complejidad técnica necesario para su implementación.",
    service_coord: "Coordinador T.I.",
    service_coord_desc: "Experiencia liderando áreas tecnológicas, coordinando equipos de trabajo y gestionando proyectos, presupuestos y recursos tecnológicos, incluyendo licenciamiento de software, infraestructura, contratos y relación con proveedores.",
  ...
  en: {
    ...
    service_back_desc: "Backend developer with solid experience in C#, .NET, PHP, and SQL, focused on building robust, scalable, and maintainable systems. I apply best practices such as Clean Code, SOLID, and KISS, perform unit testing to ensure software quality, and manage integrations using REST APIs.",
    service_back_desc2: "I have experience in version control, issue resolution, and technical documentation, delivering efficient solutions aligned with business needs.",
    service_data: "Data Analyst and SQL",
    service_data_desc: "Data Analyst with analytical skills and proficiency in SQL, focused on extracting, transforming, and analyzing information for decision-making.",
    service_data_desc2: "I have experience with SQL Server and PostgreSQL, as well as basics in MongoDB, enabling me to work with structured and unstructured data, supporting processes of support, optimization, and development of data-driven solutions.",
    service_marketing: "Digital Marketing",
    service_marketing_desc: "As a developer with self-taught skills in design and digital marketing, I have the ability to identify opportunities for improvement in digital presence and apply strategic adjustments that align the technical solution with business objectives.",
    service_analista: "Development Analyst",
    service_analista_desc: "Thanks to my solid technical experience and analytical skills, I can identify and define requirements for application development, accurately assessing the scope, timelines, costs, and level of technical complexity required for implementation.",
    service_coord: "IT Coordinator",
    service_coord_desc: "Experience leading technology areas, coordinating work teams and managing projects, budgets and technological resources, including software licensing, infrastructure, contracts and supplier relations.",
