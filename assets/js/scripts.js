...
const TRANSLATIONS = {
  es: {
    ...
    exp_buh_logro1: "Proyecto escalado a empresa legalmente constituida (Buhodemica S.A.S.), con plataforma desplegada en producción, servidor propio y base de usuarios activos.",
  ...
  en: {
    ...
    exp_buh_logro1: "Project scaled into a legally incorporated company (Buhodemica S.A.S.), with platform deployed in production, own server, and active user base.",
