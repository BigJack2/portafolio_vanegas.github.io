...
const TRANSLATIONS = {
  es: {
    ...
    about_rol: "Desarrollador Mid · C# & .NET · Blazor · Laravel",
    about_experiencia: "Más de cuatro años en Siesa como Desarrollador Mid, contribuyendo al desarrollo de un ERP empresarial de alto nivel técnico: APIs REST, pruebas unitarias con xUnit, integración de IA y flujos ágiles con GitLab y Jira. En paralelo, desarrollo InventoryBox, una plataforma SaaS multiempresa de gestión empresarial construida desde cero con Laravel 12, PHP 8.3 y MySQL 8, donde aplico arquitectura multi-tenant, RBAC, 2FA, reportes avanzados y DevOps.",
    ...
    about_edad: "Edad",
    about_grado: "Nivel",
    about_grado_valor: "Desarrollador Mid",
    about_correo: "Correo",
    ...
    exp_buh_item4: "Desarrollo Mid (PHP, SQL).",
    ...
    exp_titulo4: "Desarrollador Mid",
    exp_js_item1: "Desarrollador Mid especializado en C# y la plataforma .NET, con enfoque en rendimiento, escalabilidad y mantenibilidad.",
    ...
    exp_titulo5: "Desarrollador Full Stack Laravel — InventoryBox",
    exp_invbox_parrafo: "<strong>InventoryBox</strong> es una plataforma SaaS multiempresa de gestión empresarial construida desde cero sobre <strong>Laravel 12, PHP 8.3 y MySQL 8</strong>. Cubre el ciclo completo de operaciones: inventarios, punto de venta (POS), órdenes de compra, facturación y reportes analíticos. Soy el desarrollador principal, responsable del análisis, arquitectura, desarrollo full-stack y despliegue.",
    exp_invbox_item1: "Arquitectura <strong>multi-tenant</strong> con scoping automático en 25+ modelos Eloquent mediante Global Scopes y 17 Policies de autorización granular.",
    exp_invbox_item2: "<strong>Punto de Venta (POS)</strong> completo: sesiones multi-turno con PIN, 12 métodos de pago, facturación con desglose de IVA por tasa, cuadre de caja y precisión monetaria exacta con Value Objects (bcmath).",
    exp_invbox_item3: "<strong>Órdenes de compra</strong> con máquina de estados de 6 estados y transiciones atómicas (previene race conditions), notificaciones por correo y portal de proveedor.",
    exp_invbox_item4: "<strong>40+ reportes</strong> en Excel (con fórmulas), PDF y API REST, con exportación asíncrona en colas para grandes volúmenes de datos.",
    exp_invbox_item5: "<strong>RBAC completo</strong> con Spatie Laravel Permission: 6 roles, 47 permisos granulares, 2FA TOTP con Google Authenticator, verificación de email y rate limiting por IP/usuario.",
    exp_invbox_item6: "<strong>API REST v1</strong> con 163 endpoints, autenticación Sanctum, 39 Form Requests, 19 API Resources e idempotencia para operaciones seguras.",
    exp_invbox_item7: "Sistema de <strong>notificaciones</strong> con 8 tipos, 4 niveles de importancia y 4 estrategias de targeting (todos, por rol, por usuario, por compañía).",
    exp_invbox_item8: "<strong>Auditoría completa</strong>: trait Auditable en 35+ modelos, logs particionados por año, registro de IP/User-Agent/correlation_id y auditoría de eventos de seguridad.",
    exp_invbox_item9: "Sistema de <strong>búsqueda híbrida</strong> (MySQL FULLTEXT + LIKE) con scoring ponderado sobre productos, órdenes de compra, proveedores y usuarios.",
    exp_invbox_item10: "<strong>DevOps</strong>: despliegue en VPS con Docker, colas con Supervisor (6 colas nombradas, 5 workers), caché y sesiones en base de datos.",
    ...
    service_back: "Desarrollador Mid",
  ...
  en: {
    ...
    about_rol: "Mid-Level Developer · C# & .NET · Blazor · Laravel",
    about_experiencia: "Over four years at Siesa as a Mid-Level Developer, contributing to a high-level enterprise ERP: REST APIs, unit testing with xUnit, AI integration and agile workflows with GitLab and Jira. In parallel, I am building InventoryBox, a multi-tenant SaaS business management platform built from scratch with Laravel 12, PHP 8.3 and MySQL 8, applying multi-tenant architecture, RBAC, 2FA, advanced reporting and DevOps.",
    ...
    about_edad: "Age",
    about_grado: "Level",
    about_grado_valor: "Mid-Level Developer",
    about_correo: "Email",
    about_freelance: "Freelance",
    ...
    exp_buh_item4: "Mid development (PHP, SQL).",
    ...
    exp_titulo4: "Mid Developer",
    exp_js_item1: "Mid developer specialized in C# and the .NET platform, focused on performance, scalability and maintainability.",
    ...
    exp_titulo5: "Full Stack Laravel Developer — InventoryBox",
    exp_invbox_parrafo: "<strong>InventoryBox</strong> is a multi-tenant SaaS business management platform built from scratch on <strong>Laravel 12, PHP 8.3 and MySQL 8</strong>. It covers the complete operations cycle: inventory, point of sale (POS), purchase orders, invoicing and analytical reports. I am the lead developer, responsible for analysis, architecture, full-stack development and deployment.",
    exp_invbox_item1: "<strong>Multi-tenant</strong> architecture with automatic scoping across 25+ Eloquent models via Global Scopes and 17 granular authorization Policies.",
    exp_invbox_item2: "Complete <strong>Point of Sale (POS)</strong>: multi-shift sessions with PIN, 12 payment methods, invoicing with VAT breakdown by rate, cash register reconciliation and exact monetary precision using Value Objects (bcmath).",
    exp_invbox_item3: "<strong>Purchase orders</strong> with a 6-state state machine and atomic transitions (prevents race conditions), email notifications and supplier portal.",
    exp_invbox_item4: "<strong>40+ reports</strong> in Excel (with formulas), PDF and REST API, with asynchronous queue-based export for large data volumes.",
    exp_invbox_item5: "Full <strong>RBAC</strong> with Spatie Laravel Permission: 6 roles, 47 granular permissions, TOTP 2FA with Google Authenticator, email verification and IP/user rate limiting.",
    exp_invbox_item6: "<strong>REST API v1</strong> with 163 endpoints, Sanctum authentication, 39 Form Requests, 19 API Resources and idempotency for safe operations.",
    exp_invbox_item7: "<strong>Notification</strong> system with 8 types, 4 importance levels and 4 targeting strategies (all, by role, by user, by company).",
    exp_invbox_item8: "Complete <strong>audit trail</strong>: Auditable trait on 35+ models, year-partitioned logs, IP/User-Agent/correlation_id tracking and security event auditing.",
    exp_invbox_item9: "<strong>Hybrid search</strong> system (MySQL FULLTEXT + LIKE) with weighted scoring across products, purchase orders, suppliers and users.",
    exp_invbox_item10: "<strong>DevOps</strong>: VPS deployment with Docker, Supervisor-managed queues (6 named queues, 5 workers), database-backed cache and sessions.",
